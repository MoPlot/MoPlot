...
utils::globalVariables(c(
  "aes", "Livelli", "Media", "CI_low", "CI_high", "x", "xend",
  "y", "yend", "color", "Group", ".data", "index", "coefficient",
  "label", "lower_ci", "upper_ci"
))
...
utils::globalVariables(c("Group_Subgroup", "Subgroup"))
